import{c as k,a as z,b as P,u as C,r as A,j as e,L as l,q as u,f as q}from"./index-DRFLCYT5.js";import{u as x}from"./useQuery-B93nF8Pp.js";import{u as R}from"./useMutation-DA3uTpRP.js";import{g as E}from"./countries-DOninoG6.js";import{c as S}from"./chargepoint_1790147948102-DERXNZnU.js";import{c as M}from"./auth-chargepoint-combined-0mIqx7uW.js";import{e as F,c as L}from"./ChargePoint-CPF50-electric-car-fleet-charging-station-EVSE-1_1790160713799-rrbcnEkG.js";import{c as $}from"./ChargePoint-Home-Flex-50A-CPH50-app-1280px__29346__78945__7114_1790148214522-yvZ7D-Rf.js";import{c as I,a as T}from"./overview-cpf50-no-bg-C0Yct3q1.js";import{C as D}from"./chevron-right-DQMfRrOu.js";import{T as K}from"./triangle-alert-DhQGp46W.js";const U=k("ShoppingBag",[["path",{d:"M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z",key:"hou9p0"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M16 10a4 4 0 0 1-8 0",key:"1ltviw"}]]),h=[L,$,I,T];function ee(){const{user:c,refreshUser:m}=z(),{toast:p}=P(),[,f]=C(),[r,o]=A.useState(null),{data:g,isLoading:b}=x({queryKey:["/api/products"]}),{data:j}=x({queryKey:["/api/user/products"]}),a=R({mutationFn:async s=>{const i=await q("POST",`/api/products/${s}/purchase`,{});if(!i.ok){const N=await i.json();throw new Error(N.message||"Erreur lors de l'achat")}return i.json()},onSuccess:()=>{u.invalidateQueries({queryKey:["/api/products"]}),u.invalidateQueries({queryKey:["/api/user/products"]}),m(),o(null),p({title:"Produit acheté !",description:"Vous commencerez à recevoir des gains demain."})},onError:s=>{o(null),p({title:"Erreur",description:s.message,variant:"destructive"})}});if(!c)return null;const v=E(c.country)?.currency||"FCFA",t=s=>`${v} ${Math.round(s).toLocaleString("fr-FR")}`,d=g?.filter(s=>!s.isFree)||[],n=(j||[]).filter(s=>s.status==="active"),y=n.length,w=n.reduce((s,i)=>s+Number(i.product?.dailyEarnings||0),0);return e.jsxs("main",{className:"cp-products-page",children:[e.jsx("style",{children:`
        .cp-products-page {
          min-height: 100%;
          padding-bottom: 76px;
          background: #ffffff;
