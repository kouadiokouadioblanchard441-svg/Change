import{a as w,j as e,L as y}from"./index-w-VynQWW.js";import{u as j}from"./useQuery-DNphDeJi.js";import{g as v}from"./countries-DOninoG6.js";import{c as z}from"./chargepoint_1790147948102-DERXNZnU.js";import{c as k}from"./auth-chargepoint-combined-0mIqx7uW.js";const N="/assets/chargepoint-empty-products-C4-_dnBZ.png",_="/assets/images_(67)_1787404892163-DX_Ouu1y.jpeg",P="/assets/maquininha-ton-e-boa_(1)_1787404928174-CM1vufyJ.webp",F="/assets/images_(59)_1787404956774-CLzfYfDq.jpeg",C="/assets/images_(58)_1787404956874-BVvpZYFD.jpeg",D="/assets/images_(69)_1787404956897-B4hFbTd3.jpeg",R="/assets/images_(67)_1787404892163-DX_Ouu1y.jpeg",A="/assets/images_(68)_1787404956953-BuLYmDEH.jpeg",f=[_,P,F,C,D,R,A];function O(){const{user:s}=w(),{data:g,isLoading:h}=j({queryKey:["/api/user/products"],staleTime:0});if(!s)return null;const a=v(s.country),o=a?.currency==="FCFA"?"XOF":a?.currency||"XOF",n=g||[];n.filter(r=>r.status==="active").length;const u=Math.round(Number(s.totalEarnings||0)),l=r=>`${r.toLocaleString("fr-FR")} ${o}`,x=r=>{if(!r)return"-";const t=new Date(r),c=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],i=t.getDate(),p=c[t.getMonth()],d=t.getFullYear(),m=String(t.getHours()).padStart(2,"0"),b=String(t.getMinutes()).padStart(2,"0");return`${i} ${p} ${d}, ${m}:${b}`};return e.jsxs("main",{className:"products-reference min-h-full bg-[#f1fff4] pb-24",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"products-screen",children:[e.jsxs("header",{className:"products-header",children:[e.jsx("img",{src:z,alt:"ChargePoint"}),e.jsx("strong",{children:"Mes produits"})]}),e.jsxs("section",{className:"products-hero","aria-label":"Produits",children:[e.jsx("img",{src:k,alt:"Solutions de recharge ChargePoint"}),e.jsxs("div",{className:"hero-copy",children:[e.jsx("strong",{children:"ChargePoint"}),e.jsx("span",{children:"Vos produits achetés et leurs revenus"})]}),e.jsxs("div",{className:"stat-panel my my-only active","aria-label":`Revenus : ${l(u)}`,children:[e.jsx("span",{className:"stat-value",children:l(u)}),e.jsx("span",{className:"stat-label",children:"Revenus cumulés"})]})]}),e.jsx("div",{className:"product-list",children:e.jsx("div",{children:h?e.jsx("div",{className:"flex justify-center py-12",children:e.jsx(y,{className:"w-8 h-8 animate-spin text-[#FF7A14]"})}):n.length===0?e.jsxs("div",{className:"empty",children:[e.jsx("img",{src:N,alt:"Aucun produit acheté"}),e.jsx("p",{children:"Aucun produit ChargePoint acheté"}),e.jsx("p",{className:"text-sm text-gray-400",children:"Achetez des produits pour commencer à gagner"})]}):n.map((r,t)=>{const c=r.product?.cycleDays||60,i=r.daysRemaining||0,p=Math.max(0,c-i),d=parseFloat(r.totalEarned||"0");return e.jsxs("div",{className:"product-card my-card","data-testid":`my-product-card-${r.id}`,children:[e.jsx("div",{className:"product-picture",children:e.jsx("img",{src:f[t%f.length],alt:r.product?.name||"Produit"})}),e.jsxs("div",{className:"product-details",children:[e.jsx("p",{className:"product-name",children:r.product?.name||"Produit"}),e.jsxs("p",{className:"product-price",children:[Number(r.product?.price||0).toLocaleString("fr-FR")," ",o]}),e.jsxs("p",{className:"product-line",children:["Jours d'exécution :",e.jsxs("strong",{children:[p," / ",c]})]}),e.jsxs("p",{className:"product-line",children:["Revenu généré :",e.jsxs("strong",{children:[d.toLocaleString("fr-FR")," ",o]})]}),e.jsxs("p",{className:"product-line",children:["Revenu total :",e.jsxs("strong",{children:[Number(r.product?.totalReturn||0).toLocaleString("fr-FR")," ",o]})]}),e.jsxs("p",{className:"product-line",children:["Date :",e.jsx("strong",{children:x(r.purchasedAt)})]})]})]},r.id)})})})]})]})}export{O as default};
