import{a as w,j as e,L as y}from"./index-BbC07fas.js";import{u as v}from"./useQuery-CmBb0iJB.js";import{g as j}from"./countries-DOninoG6.js";import{e as z,c as k}from"./ChargePoint-CPF50-electric-car-fleet-charging-station-EVSE-1_1790160713799-rrbcnEkG.js";import{c as N}from"./chargepoint_1790147948102-DERXNZnU.js";import{c as P}from"./auth-chargepoint-combined-0mIqx7uW.js";import{c as F}from"./ChargePoint-Home-Flex-50A-CPH50-app-1280px__29346__78945__7114_1790148214522-yvZ7D-Rf.js";import{c as R,a as A}from"./overview-cpf50-no-bg-C0Yct3q1.js";const f=[k,F,R,A];function O(){const{user:i}=w(),{data:h,isLoading:g}=v({queryKey:["/api/user/products"],staleTime:0});if(!i)return null;const a=j(i.country),o=a?.currency==="FCFA"?"XOF":a?.currency||"XOF",s=h||[];s.filter(r=>r.status==="active").length;const u=Math.round(Number(i.totalEarnings||0)),l=r=>`${r.toLocaleString("fr-FR")} ${o}`,x=r=>{if(!r)return"-";const t=new Date(r),c=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],n=t.getDate(),p=c[t.getMonth()],d=t.getFullYear(),m=String(t.getHours()).padStart(2,"0"),b=String(t.getMinutes()).padStart(2,"0");return`${n} ${p} ${d}, ${m}:${b}`};return e.jsxs("main",{className:"products-reference min-h-full bg-[#f1fff4] pb-24",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"products-screen",children:[e.jsxs("header",{className:"products-header",children:[e.jsx("img",{src:N,alt:"ChargePoint"}),e.jsx("strong",{children:"Mes produits"})]}),e.jsxs("section",{className:"products-hero","aria-label":"Produits",children:[e.jsx("img",{src:P,alt:"Solutions de recharge ChargePoint"}),e.jsxs("div",{className:"hero-copy",children:[e.jsx("strong",{children:"ChargePoint"}),e.jsx("span",{children:"Vos produits achetés et leurs revenus"})]}),e.jsxs("div",{className:"stat-panel my my-only active","aria-label":`Revenus : ${l(u)}`,children:[e.jsx("span",{className:"stat-value",children:l(u)}),e.jsx("span",{className:"stat-label",children:"Revenus cumulés"})]})]}),e.jsx("div",{className:"product-list",children:e.jsx("div",{children:g?e.jsx("div",{className:"flex justify-center py-12",children:e.jsx(y,{className:"w-8 h-8 animate-spin text-[#FF7A14]"})}):s.length===0?e.jsxs("div",{className:"empty",children:[e.jsx("img",{src:z,alt:"Aucun produit acheté"}),e.jsx("p",{children:"Aucun produit ChargePoint acheté"}),e.jsx("p",{className:"text-sm text-gray-400",children:"Achetez des produits pour commencer à gagner"})]}):s.map((r,t)=>{const c=r.product?.cycleDays||60,n=r.daysRemaining||0,p=Math.max(0,c-n),d=parseFloat(r.totalEarned||"0");return e.jsxs("div",{className:"product-card my-card","data-testid":`my-product-card-${r.id}`,children:[e.jsx("div",{className:"product-picture",children:e.jsx("img",{src:f[t%f.length],alt:r.product?.name||"Produit"})}),e.jsxs("div",{className:"product-details",children:[e.jsx("p",{className:"product-name",children:r.product?.name||"Produit"}),e.jsxs("p",{className:"product-price",children:[Number(r.product?.price||0).toLocaleString("fr-FR")," ",o]}),e.jsxs("p",{className:"product-line",children:["Jours d'exécution :",e.jsxs("strong",{children:[p," / ",c]})]}),e.jsxs("p",{className:"product-line",children:["Revenu généré :",e.jsxs("strong",{children:[d.toLocaleString("fr-FR")," ",o]})]}),e.jsxs("p",{className:"product-line",children:["Revenu total :",e.jsxs("strong",{children:[Number(r.product?.totalReturn||0).toLocaleString("fr-FR")," ",o]})]}),e.jsxs("p",{className:"product-line",children:["Date :",e.jsx("strong",{children:x(r.purchasedAt)})]})]})]},r.id)})})})]})]})}export{O as default};
