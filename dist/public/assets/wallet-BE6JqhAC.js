import{c as _,a as ee,b as te,u as ae,d as re,r as c,j as e,L as $,e as le,q as N,f as C}from"./index-dd3oW_Vi.js";import{u as F}from"./useQuery-B_iMerRu.js";import{u as S}from"./useMutation-a80MLdvz.js";import{u as oe,C as P,t as se,o as ie,s as A}from"./types-BMPdWgIc.js";import{a as ne}from"./countries-DOninoG6.js";import{e as ce}from"./illustration-8_1784762965573-C2eE_S1I.js";import{c as de}from"./auth-chargepoint-combined-0mIqx7uW.js";import{w as pe}from"./account-wallet-DgIYQb9G.js";import{C as q}from"./chevron-left-D_AWWhyT.js";import{X as R}from"./x-R0GvHVoP.js";import{S as D}from"./search-BWwtHXYK.js";import{C as z}from"./check-xaXOp-xr.js";import{P as T,T as fe}from"./trash-2-6WIUihhk.js";import{C as ue}from"./chevron-right-CTZ1ahHF.js";const xe=_("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]),me=ie({accountNumber:A().min(8,"Numéro requis"),paymentMethod:A().min(2,"Moyen de paiement requis")});function he(l){const a=l.replace(/\s+/g,"");return a.length<=6?l:`${a.slice(0,2)}••••••${a.slice(-4)}`}function we(l){const a=l.toLowerCase();return a.includes("orange")?"/operators/orange.png":a.includes("mtn")?"/operators/mtn.png":a.includes("moov")?"/operators/moov.jpg":a.includes("airtel")?"/operators/airtel.png":a.includes("wave")?"/operators/wave.png":a.includes("tmoney")||a.includes("t-money")?"/operators/tmoney.png":"/chargepoint-icon-512.png"}const I=`
  .wallet-page {
    width: 100%;
    min-height: 100dvh;
    overflow-x: hidden;
