import{a as g,b as m,u,j as e,L as b,q as d,f as k}from"./index-CdmR7Oi6.js";import{u as j}from"./useQuery-CoqyfAkX.js";import{u as w}from"./useMutation-C9IKi5j6.js";import{g as v}from"./countries-DOninoG6.js";import{c as l}from"./chargepoint_1790147948102-DERXNZnU.js";import{c as p}from"./auth-chargepoint-combined-0mIqx7uW.js";import{c as y}from"./ChargePoint-Home-Flex-50A-CPH50-app-1280px__29346__78945__7114_1790148214522-yvZ7D-Rf.js";import{C as N}from"./chevron-left-C1C5arPG.js";function F(){const{user:t}=g(),{toast:s}=m(),[,h]=u(),{data:n}=j({queryKey:["/api/daily-bonus-status"],refetchInterval:6e4}),i=w({mutationFn:async()=>{const r=await k("POST","/api/claim-daily-bonus",{});if(!r.ok){const c=await r.json();throw new Error(c.message||"Erreur")}return r.json()},onSuccess:r=>{d.invalidateQueries({queryKey:["/api/daily-bonus-status"]}),d.invalidateQueries({queryKey:["/api/user"]});const c=Number(r?.amount||0);s({title:"Bonus reçu !",description:`${c} FCFA ajoutés à votre solde`})},onError:r=>{s({title:"Erreur",description:r.message,variant:"destructive"})}});if(!t)return null;const o=v(t.country)?.currency||"XOF",x=n?.totalBonusClaimed||0,a=!!n?.canClaim,f=r=>`${Math.round(r).toLocaleString("fr-FR")}${o}`;return e.jsxs("main",{className:"checkin-reference min-h-full bg-[#f4f4f4] pb-20",children:[e.jsx("style",{children:`
        .checkin-reference {
          color: #111827;
