import{c as _,a as ee,b as te,u as ae,d as re,r as c,j as e,L as A,e as le,q as N,f as C}from"./index-CkzHRE8k.js";import{u as F}from"./useQuery-j4m9DStk.js";import{u as S}from"./useMutation-CTOo041b.js";import{u as oe,C as P,t as se,o as ie,s as E}from"./types-DMMlgraM.js";import{a as ne}from"./countries-kCzl-GJX.js";import{e as ce}from"./illustration-8_1784762965573-C2eE_S1I.js";import{c as de}from"./auth-chargepoint-combined-0mIqx7uW.js";import{w as pe}from"./account-wallet-DgIYQb9G.js";import{C as q}from"./chevron-left-BgSclrhl.js";import{X as R}from"./x-DKlOTWnL.js";import{S as D}from"./search-Bk8FloYV.js";import{C as z}from"./check-BXCWtpih.js";import{P as T,T as fe}from"./trash-2-D0nHpXDZ.js";import{C as ue}from"./chevron-right-BJXCZceH.js";const xe=_("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]),me=ie({accountNumber:E().min(8,"Numéro requis"),paymentMethod:E().min(2,"Moyen de paiement requis")});function he(l){const a=l.replace(/\s+/g,"");return a.length<=6?l:`${a.slice(0,2)}••••••${a.slice(-4)}`}function we(l){const a=l.toLowerCase();return a.includes("orange")?"/operators/orange.png":a.includes("mtn")?"/operators/mtn.png":a.includes("moov")?"/operators/moov.jpg":a.includes("airtel")?"/operators/airtel.png":a.includes("wave")?"/operators/wave.png":a.includes("tmoney")||a.includes("t-money")?"/operators/tmoney.png":"/chargepoint-icon-512.png"}const I=`
  .wallet-page {
    width: 100%;
    min-height: 100dvh;
    overflow-x: hidden;
