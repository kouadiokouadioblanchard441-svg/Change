import{c as te,a as ae,b as re,u as le,d as oe,r as c,j as e,L as A,e as se,q as N,f as C}from"./index-CR7zAcd-.js";import{u as E}from"./useQuery-DAwrv5c4.js";import{u as S}from"./useMutation-DxSNPBXC.js";import{u as ie,C as P,t as ne,o as ce,s as q}from"./types-DU9-UikX.js";import{c as de,b as pe}from"./countries-D1-0ri_i.js";import{e as fe}from"./illustration-8_1784762965573-C2eE_S1I.js";import{c as ue}from"./auth-chargepoint-combined-0mIqx7uW.js";import{w as xe}from"./account-wallet-DgIYQb9G.js";import{C as R}from"./chevron-left-DOiYdiZv.js";import{X as D}from"./x-C-Rr2X-f.js";import{S as T}from"./search-1cZExeXg.js";import{C as z}from"./check-DRdzyZCM.js";import{P as I,T as me}from"./trash-2-Do-tvlOR.js";import{C as he}from"./chevron-right-Q0jNDbmZ.js";const we=te("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]),ge=ce({accountNumber:q().min(8,"Numéro requis"),paymentMethod:q().min(2,"Moyen de paiement requis")});function be(l){const a=l.replace(/\s+/g,"");return a.length<=6?l:`${a.slice(0,2)}••••••${a.slice(-4)}`}function ye(l){const a=l.toLowerCase();return a.includes("orange")?"/operators/orange.png":a.includes("mtn")?"/operators/mtn.png":a.includes("moov")?"/operators/moov.jpg":a.includes("airtel")?"/operators/airtel.png":a.includes("wave")?"/operators/wave.png":a.includes("tmoney")||a.includes("t-money")?"/operators/tmoney.png":"/chargepoint-icon-512.png"}const W=`
  .wallet-page {
    width: 100%;
    min-height: 100dvh;
    overflow-x: hidden;
