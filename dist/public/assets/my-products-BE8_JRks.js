import{a as M,b as T,d as I,r as N,j as e,L as f,q as k,f as q}from"./index-CXLLAcSD.js";import{u as z}from"./useQuery-Cm1Gh3pq.js";import{u as O}from"./useMutation-yfmGoYeJ.js";import{g as U}from"./countries-DOninoG6.js";import{e as P}from"./illustration-8_1784762965573-C2eE_S1I.js";import{c as J}from"./chargepoint_1790147948102-DERXNZnU.js";import{c as B}from"./auth-chargepoint-combined-0mIqx7uW.js";const H="/assets/images_(67)_1787404892163-DX_Ouu1y.jpeg",K="/assets/maquininha-ton-e-boa_(1)_1787404928174-CM1vufyJ.webp",V="/assets/images_(59)_1787404956774-CLzfYfDq.jpeg",X="/assets/images_(58)_1787404956874-BVvpZYFD.jpeg",Y="/assets/images_(69)_1787404956897-B4hFbTd3.jpeg",Q="/assets/images_(67)_1787404892163-DX_Ouu1y.jpeg",G="/assets/images_(68)_1787404956953-BuLYmDEH.jpeg",a=[H,K,V,X,Y,Q,G];function ie(){const{user:d,refreshUser:C}=M(),{toast:m}=T(),F=I(),R=new URLSearchParams(F).get("tab")==="my"?"my":"our",[i,b]=N.useState(R),[p,c]=N.useState(null),{data:S,isLoading:A}=z({queryKey:["/api/products"],staleTime:0}),{data:_,isLoading:$}=z({queryKey:["/api/user/products"],staleTime:0}),l=O({mutationFn:async t=>{const r=await q("POST",`/api/products/${t}/purchase`,{});if(!r.ok){const s=await r.json();throw new Error(s.message||"Erreur")}return r.json()},onSuccess:()=>{k.invalidateQueries({queryKey:["/api/products"]}),k.invalidateQueries({queryKey:["/api/user/products"]}),C(),c(null),m({title:"Produit acheté !",description:"Vous commencerez à recevoir des gains demain."})},onError:t=>{c(null),m({title:"Erreur",description:t.message,variant:"destructive"})}});if(!d)return null;const y=U(d.country),o=y?.currency==="FCFA"?"XOF":y?.currency||"XOF",j=S?.filter(t=>!t.isFree)||[],u=_||[],n=u.filter(t=>t.status==="active").length,w=Math.round(Number(d.totalEarnings||0)),v=t=>`${t.toLocaleString("fr-FR")} ${o}`,D=t=>{if(!t)return"-";const r=new Date(t),s=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],x=r.getDate(),h=s[r.getMonth()],g=r.getFullYear(),E=String(r.getHours()).padStart(2,"0"),L=String(r.getMinutes()).padStart(2,"0");return`${x} ${h} ${g}, ${E}:${L}`};return e.jsxs("main",{className:"products-reference min-h-full bg-[#f1fff4] pb-24",children:[e.jsx("style",{children:`
