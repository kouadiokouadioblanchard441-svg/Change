import{a as l,b as d,r as p,j as e,e as u,L as h,f as m}from"./index-DT8r0tFy.js";import{u as x}from"./useQuery-BKy2GnoK.js";import{u as b}from"./useMutation-kC7bOg3S.js";import{C as j}from"./chevron-right-DtRi-Lnn.js";const w="/assets/IMG-20260821-WA0140_1787390560133-7fET19PL.jpg",y="/assets/tg-1_1787367952311-7lN49whF.png";function N(){const{refreshUser:o}=l(),{toast:i}=d(),[r,n]=p.useState(""),{data:f}=x({queryKey:["/api/settings"]}),a=b({mutationFn:async t=>{const s=await m("POST","/api/gift-codes/claim",{code:t});if(!s.ok){const g=await s.json();throw new Error(g.message||"Erreur")}return s.json()},onSuccess:t=>{o(),n(""),i({title:"Félicitations !",description:t.message})},onError:t=>{i({title:"Erreur",description:t.message,variant:"destructive"})}}),c=()=>{if(!r.trim()){i({title:"Erreur",description:"Veuillez saisir un code",variant:"destructive"});return}a.mutate(r.trim())};return e.jsxs("main",{className:"gift-reference",children:[e.jsx("style",{children:`
