...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      style={{ borderColor: isTeam ? "rgba(255, 122, 20, 0.3)" : "rgba(0, 204, 44, 0.2)" }}
          ...
          return (
            ...
            >
              <span
                ...
                style={{
                  backgroundColor: isActive ? (isTeam ? "#ff7a14" : "#00cc2c") : "#8f969b",
              ...
              <span
                ...
                style={{ color: isActive ? (isTeam ? "#9e4100" : "#00cc2c") : "#55565a" }}
              >
                {item.label}
              </span>
            </button>
