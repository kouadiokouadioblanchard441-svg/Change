  ...
  return (
    <main className="auth-reference auth-login">
      <style>{`
        ...
        .auth-reference .auth-prefix { display: flex; flex: 0 1 auto; min-width: 0; align-items: center; gap: clamp(6px, 2.15vw, 11px); margin-right: clamp(8px, 3.32vw, 17px); border: 0; padding: 0; background: transparent; color: #f97316; font-size: clamp(20px, 5.47vw, 28px); line-height: 1; white-space: nowrap; }
