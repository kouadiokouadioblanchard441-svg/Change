...
export default function LoginPage() {
  ...
  return (
    <main className="auth-reference auth-login">
      <style>{`
         .auth-reference { width: 100%; min-height: 100dvh; overflow-x: hidden; background: #ffffff; color: #00c926; font-family: Arial, sans-serif; }
        ...
        .auth-reference .auth-fields { display: grid; gap: 20px; }
         .auth-reference .auth-field { display: flex; width: 100%; min-width: 0; height: 67px; align-items: center; overflow: hidden; border: 1px solid #e3e8e4; border-radius: 11px; padding: 0 clamp(12px, 3.9vw, 20px); background: #fff; box-shadow: 0 1px 2px rgba(0, 128, 30, .12); }
